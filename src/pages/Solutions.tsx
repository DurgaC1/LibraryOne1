...
const solutions = [
  {
    icon: BookOpen,
    title: "Boundless",
    description: "An extensive digital library including eBooks, audiobooks, videobooks, activities, and more!",
    link: "/boundless",
  },
  {
    icon: ShoppingCart,
    title: "Title Source 360",
    description: "Select print, eBook, and entertainment titles for easy ordering and fast delivery with Title Source 360. Choose from in-stock titles within our established distribution network.",
