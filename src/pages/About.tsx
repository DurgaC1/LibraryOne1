                ...
                <div className="bg-card rounded-2xl border border-border card-elevated p-5 max-w-md w-full">
                  ...
                  <div className="mt-4">
                    ...
                    <div className="h-1.5 w-full rounded-full bg-secondary overflow-hidden">
                      <div className="h-full w-2/3 rounded-full bg-gradient-to-r from-primary via-cyan-500 to-primary animate-[pulse_2.2s_ease-in-out_infinite]" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-card rounded-2xl border border-border card-elevated p-5 md:p-6 shadow-lg relative overflow-hidden">
                  ...
                  {mascotsLoading ? (
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="h-28 md:h-32 rounded-xl bg-gradient-to-tr from-primary/40 via-cyan-500/40 to-primary/40 flex items-center justify-center">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value) => (
                ...
                >
                  <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-primary via-cyan-500 to-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
