    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 pt-24 pb-16">
        <section className="container mx-auto px-4 space-y-12">
          ...
          <div className="grid gap-8 md:grid-cols-2 items-center">
            <div>
              ...
              <h1 className="font-display text-3xl md:text-4xl font-bold mb-4">
                ...
                <span className="text-primary">out into the community</span>
              </h1>
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden shadow-xl border border-border/60 bg-card">
                <img
                  src={epopupHero}
              ...
              <div className="hidden md:block absolute -bottom-6 -left-6 w-40 h-40 rounded-2xl overflow-hidden border border-border/60 shadow-lg bg-card">
                <img
                  src={epopupDetail}
          ...
          {/* How does it work? */}
          <section className="rounded-2xl border border-border bg-card/60 p-6 md:p-8 shadow-sm">
